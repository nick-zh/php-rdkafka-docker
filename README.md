...
[`latest`, `74-fpm-alpine-lib-1.4.0-ext-4.0.3-composer` (Dockerfile)](https://github.com/nick-zh/php-rdkafka-docker/blob/74-fpm-alpine3.11-lib-1.4.0-ext-4.0.3-composer/Dockerfile "Dockerfile")  
